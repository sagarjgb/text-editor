...
const Edi2 = () => {
  ...
  const handlePostsPerPageChange = (perPage) => {
...
{/* clipboard */}
      ...
      data-clipboard-target="#editor">copy</button>
      <button id='btnCut'
      data-clipboard-action="cut"
      data-clipboard-target="#editor">cut</button>

      <button id="btnPaste"
      data-clipboard-action="paste"
      data-clipboard-target="#editor">paste</button>
